...
flowchart TD
    ...
    R -->|"in booking-day order"| PE["post_event()<br/><i>ledger/core.py:363</i>"]

    PE --> H{"event kind"}
    H -->|credit / debit| TS["_two_sided()<br/><i>ledger/core.py:376</i>"]
    H -->|settlement| SET["_on_settlement()<br/><i>ledger/core.py:417</i>"]
    H -->|"settlement, no auth"| FP["_force_post()<br/>→ suspense<br/><i>ledger/core.py:446</i>"]
    H -->|reversal| REV["_on_reversal()<br/><i>ledger/core.py:470</i>"]
    H -->|authorisation| AU["_on_authorization()<br/><i>ledger/core.py:398</i>"]
    ...
    R -->|"end of each day"| CD["close_day()<br/><i>ledger/core.py:513</i>"]
    CD --> RF["_refuse_unchargeable_fees()<br/><i>ledger/core.py:534</i>"]
    RF --> MF["_maybe_assess_fee()<br/><i>ledger/core.py:555</i>"]
    MF --> C
    R -->|"end of Day 6"| CI["capitalize_interest()<br/><i>ledger/core.py:570</i>"]
    CI --> C
    ...
    LOG --> CB["closing_balance()<br/><i>ledger/core.py:321</i>"]
    LOG --> TB["trial_balance()<br/><i>ledger/core.py:329</i>"]
